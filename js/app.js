(() => {
    ...
    function initSliders() {
        if (document.querySelector(".programs__swiper")) new swiper_core_Swiper(".programs__swiper", {
            breakpoints: {
                320: {
                    slidesPerView: 1
                },
            ...
            speed: 800,
            pagination: {
                el: ".programs__bullets",
                clickable: true
            },
            navigation: {
                prevEl: ".programs__arrow--left",
                nextEl: ".programs__arrow--right"
            },
            on: {}
        });
    }
    ...
    function initSlidersSecond() {
        if (document.querySelector(".sample__swiper")) new swiper_core_Swiper(".sample__swiper", {
            breakpoints: {
                320: {
                    slidesPerView: 1
                },
            ...
            speed: 800,
            navigation: {
                prevEl: ".sample__arrow--left",
                nextEl: ".sample__arrow--right"
            },
            on: {}
        });
    }
